"""
Path utilities for dynamic project root resolution.

This module provides utilities to resolve paths relative to the project root,
making the codebase portable across different installations.
"""
...
def get_project_root() -> Path:
    ...
    # Fallback: if not found, return the parent of agent_system
