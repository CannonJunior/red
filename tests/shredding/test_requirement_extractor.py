...
class TestRequirementExtractor:
    ...
    def test_mandatory_shall_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=15)
        ...
        assert requirements[0].page_number == 15
    ...
    def test_mandatory_must_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=20)
    ...
    def test_mandatory_will_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="L", start_page=5)
    ...
    def test_recommended_should_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="M", start_page=10)
    ...
    def test_optional_may_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=25)
    ...
    def test_optional_can_keyword(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="L", start_page=3)
    ...
    def test_multiple_requirements_single_text(self, extractor):
        ...
        """
        requirements = extractor.extract_requirements(text, section="C", start_page=30)
    ...
    def test_conditional_requirement(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=18)
    ...
    def test_no_requirements_in_descriptive_text(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="A", start_page=1)
    ...
    def test_deduplication(self, extractor):
        ...
        """
        reqs = extractor.extract_requirements(text, section="C", start_page=22)
        requirements = extractor.deduplicate_requirements(reqs)
    ...
    def test_page_number_preservation(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="L", start_page=42)

        assert len(requirements) == 1
        assert requirements[0].page_number == 42
    ...
    def test_section_preservation(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="M", start_page=8)
    ...
    def test_paragraph_id_extraction(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=16)

        assert len(requirements) == 1
        # Check if paragraph ID is detected (if implemented)
        if requirements[0].paragraph_id is not None:
            assert '3.2.1' in str(requirements[0].paragraph_id)

    def test_empty_text_handling(self, extractor):
        """Test handling of empty or whitespace-only text."""
        requirements = extractor.extract_requirements("", section="C", start_page=1)
        assert len(requirements) == 0

        requirements = extractor.extract_requirements("   \n\n  ", section="C", start_page=1)
        assert len(requirements) == 0
    ...
    def test_special_characters_handling(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=12)
    ...
    def test_required_keyword_variant(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=7)
    ...
    def test_mixed_case_keywords(self, extractor):
        ...
        requirements = extractor.extract_requirements(text, section="C", start_page=14)
